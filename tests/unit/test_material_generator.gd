...
func get_coverage_entries() -> Array:
	return [["res://shared/graphics/material_generator.gd", ["get_material", "create_pbr_material", "clear_cache"]]]
...
func test_named_materials() -> void:
	var names = ["sci_fi_metal", "neon_cyan", "neon_orange", "dark_concrete", "asphalt", "grass", "neon_red", "neon_green", "neon_blue", "nitro_fire", "sparks", "drift_smoke"]
